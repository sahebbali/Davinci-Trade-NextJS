...
const testimonials = [
  {
    id: 1,
    quote:
      "DaVinci-Trade has revolutionized my approach to the market. The analytics are unparalleled!",
    author: "Jane Doe",
  ...
  },
  {
    id: 2,
    quote:
      "The security and community support here are fantastic. I feel truly empowered.",
    author: "John Smith",
  ...
  },
  {
    id: 3,
    quote:
      "Finally, a platform that combines powerful tools with a user-friendly experience. Highly recommended!",
    author: "Emily White",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          ...
          <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
            Hear from our satisfied users who are achieving their financial
            goals with DaVinci-Trade.
          </p>
        </div>
